...
import (
	...
	str "github.com/xslasd/oidc/pkg/strings"
)
...
func RedirectToLogin(authReqID, state string, client Client, w http.ResponseWriter, r *http.Request) {
	login := client.LoginURL(authReqID, state)
